...
| `/crb default` | codex's own default | medium | ~17s | Normal development |
...
| `CRB_MODEL` | codex default | Override Codex model (`gpt-5.5`, `gpt-5.4`, `gpt-5.4-mini`, `gpt-5.3-codex`, etc.). Note: `gpt-5.5` is available via Codex ChatGPT sign-in only; API-key auth returns 404. |
